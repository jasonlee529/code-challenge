...
public class BreakingTheRecords {
    static int[] getRecord(int[] s) {
        ...
        return new int[]{mostTimes, leaseTimes};
    }
...
//            s[s_i] = in.nextInt();
//        }
        // int[] result = getRecord(new int[]{10, 5, 20, 20, 4, 5, 2, 25, 1});
        int[] result = getRecord(new int[]{3, 4, 21, 36, 10, 28, 35, 5, 24, 42});
