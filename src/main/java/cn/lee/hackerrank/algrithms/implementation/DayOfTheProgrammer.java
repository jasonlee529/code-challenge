...
public class DayOfTheProgrammer {
    public static void main(String[] args) {
        ...
        // int year = in.nextInt();
        String result = solve(2017);
        System.out.println(result);
        String r2 = solve(2016);
        System.out.println(r2);
        String r3 = solve(1918);
        System.out.println(r3);
        String r4 = solve(1917);
        System.out.println(r4);
        String r5 = solve(1919);
    ...
    static String solve(int year) {
        ...
        if (year == 1918) {
            ...
            return learpYear(year, day);
        } else if (year > 1918 && (year % 400 == 0 || (year % 4 == 0 && year % 100 != 0))) {
            return learpYear(year, day);
        }
        return normal(year, day);
    }

    static String normal(int year, int day) {
        int[] days = new int[]{31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30};
        return getDateString(year, day, days);
    }

    static String learpYear(int year, int day) {
        int[] days = new int[]{31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30};
        return getDateString(year, day, days);
    }

    private static String getDateString(int year, int day, int[] days) {
        int sum = 0;
        int month = 1;
        int date = 1;
    ...
    static String year1918(int day) {
        int[] days = new int[]{31, 15, 31, 30, 31, 30, 31, 31, 30, 31, 30};
        return getDateString(1918, day, days);
    }
}
